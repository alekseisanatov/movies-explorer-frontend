...
function InfoToolTip(props) {
  return(
    <div className={`info ${props.isAcceptedPopupOpen ? 'info__active' : ''}`}>
      <div className="info__wrapper">
        <button className={'info__button'}>
          <img className={'info__button-close'} src={closeImage} alt="Закрыть"/>
        </button>
        <img className={'info__image'} src={props.isAcceptedPopupOpen ? acceptedImage : declinedImage} alt="Статус"/>
